...
<!-- SCRIPTS -->
<script type="text/javascript" src="../js/shn5sjh.js"></script>
...
<header role="masthead">
	...
	<nav>
		<ul>
			<li id="t-blog"><a href="foodsense-blog.html">博客</a></li>
			...
			<li id="t-tastemakers"><a href="http://foodsense.is/tastemakers">商品列表</a></li>
...
<div id="content">
	...
	<section id="slide-3" >
		<img src="../img/slides/0232_foodsense.jpg" alt="Share your Food Sense" />
		<a href="#contribute">
		<h1>分享你自己的食谱</h1>
		<h2>给我分享一下你制作的食物, 哪怕是一张照片, 或者是您家人朋友制作的</h2>
		</a>
		<p class="credit">photo by <a href="http://clarebarboza.com/">Clare Barboza</a></p>
		</section>
	
	
	<section id="slide-4" class="alt">
		<img src="../img/0140_foodsense.jpg" alt="What's Cooking? " />
		<a href="#tastemakers">
		<h1>只卖最好的</h1>
		<h2>我的菜品需要预定; 朋友的商品, 绝对都是美味佳肴或优质食材</h2>
		</a>
		<p class="credit">photo by <a href="http://clarebarboza.com/">Clare Barboza</a></p>
		</section>
	...
	<div id="nav">
		<ul>
			<li id="feature-1"><a href="#blog"><h3>博客</h3><p>制作食物的新闻, 技巧, 故事, 心得 ...</p></a></li>
			<li id="feature-2"><a href="#a-list"><h3>经典菜谱</h3><p>精挑细选，我的最爱</p></a></li>
			<li id="feature-3"><a href="#contribute"><h3>友情贡献</h3><p>我想听到你的声音, 分享一下你周围的新鲜事吧</p></a></li>
			<li id="feature-4"><a href="#tastemakers"><h3>商品列表</h3><p>有我的菜品, 也有朋友的商品, 绝对都是美味佳肴或优质食材</p></a></li>
		</ul>
	</div>
...
<footer role="siteinfo">
	<p><a href="http://foodsense.is/legal">Privacy Policy</a> | <a href="http://foodsense.is/legal#terms">Terms of Use</a> | <span id='eeEncEmail_gldyGmEJZp'>.(JavaScript must be enabled to view this email address)</span><script type="text/javascript">/*<![CDATA[*/var l=new Array();var output = '';l[0]='>';l[1]='a';l[2]='/';l[3]='<';l[4]=' 116';l[5]=' 99';l[6]=' 97';l[7]=' 116';l[8]=' 110';l[9]=' 111';l[10]=' 67';l[11]='>';l[12]='\"';l[13]=' 115';l[14]=' 105';l[15]=' 46';l[16]=' 101';l[17]=' 115';l[18]=' 110';l[19]=' 101';l[20]=' 115';l[21]=' 100';l[22]=' 111';l[23]=' 111';l[24]=' 102';l[25]=' 64';l[26]=' 111';l[27]=' 108';l[28]=' 108';l[29]=' 101';l[30]=' 104';l[31]=':';l[32]='o';l[33]='t';l[34]='l';l[35]='i';l[36]='a';l[37]='m';l[38]='\"';l[39]='=';l[40]='f';l[41]='e';l[42]='r';l[43]='h';l[44]='a ';l[45]='<';for (var i = l.length-1; i >= 0; i=i-1){ if (l[i].substring(0, 1) == ' ') output += "&#"+unescape(l[i].substring(1))+";"; else output += unescape(l[i]);}document.getElementById('eeEncEmail_gldyGmEJZp').innerHTML = output;/*]]>*/</script><br />&copy; 2015 Food Sense, all rights reserved.</p>
	<div class="social">
		<ul>
