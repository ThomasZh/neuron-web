...
<body style="background:#ffffff">
    <div>
      <ul id="blackboard">
        <li>
          <a style="background:url(../../resources/images/mala.jpg); background-size:contain " id="plus" class="black" href="add">
            <img src="../../resources/images/plus-white.png" width="100%" height="100%" />
          </a>
        </li>
        <c:forEach items="${boards}" var="board" varStatus="stat">
        <li>
          <a style="background:url(../../resources/images/mala.jpg); background-size:contain" id="${board.id}" class="black" name="boardlinks" href="../stickynote/index?boardId=${board.id}">
            <h2>${board.title}</h2>
          </a>
        </li>
        </c:forEach>
